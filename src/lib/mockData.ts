...
export const mockApplications: Application[] = [
  {
    ...
    description: '月次の勤怠報告を提出してください。出勤日数、休暇取得状況などを入力します。',
    notes: '毎月25日までに必ず提出してください。遅延すると給与計算に影響する可能性があります。',
    isPublished: true
  },
  {
    id: '2',
    ...
    description: '有給休暇を取得する場合は、#人事チャンネルで申請してください。',
...
export const mockMessages: Message[] = [
  {
    ...
    senderId: 'admin1',
    receiverId: '1',
    content: '勤怠報告の提出期限が近づいています。お忘れなく提出をお願いします。',
