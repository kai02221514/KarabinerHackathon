...
export default function Header({ userName, onLogout, role, onNavigate, currentPage, unreadMessagesCount = 0 }: HeaderProps) {
            ...
            {role === 'employee' && (
              <nav className="hidden md:flex gap-6">
                <button
                  ...
                  className={` ${
                    currentPage === 'employee-home' || !currentPage ? 'text-blue-600' : 'text-gray-700'
                  }`}
                >
                  ホーム
                </button>
                <button
                  ...
                  className={` ${
                    currentPage === 'employee-applications' ? 'text-blue-600' : 'text-gray-700'
                  }`}
                >
                  申請一覧
                </button>
                <button
                  ...
                  className={` ${
                    currentPage === 'employee-my-applications' ? 'text-blue-600' : 'text-gray-700'
                  }`}
                >
                  マイ申請
                </button>
            ...
            {role === 'admin' && (
              <nav className="hidden md:flex gap-6">
                <button
                  ...
                  className={` ${
                    currentPage === 'admin-home' || !currentPage ? 'text-blue-600' : 'text-gray-700'
                  }`}
                >
                  ホーム
                </button>
                <button
                  ...
                  className={` ${
                    currentPage === 'admin-forms' ? 'text-blue-600' : 'text-gray-700'
                  }`}
                >
                  フォーム管理
                </button>
                <button
                  ...
                  className={` ${
                    currentPage === 'admin-users' || currentPage === 'admin-user-chat' ? 'text-blue-600' : 'text-gray-700'
                  }`}
                >
                  メッセージ
                </button>
                  ...
                  {role === 'employee' && (
                    <nav className="flex flex-col gap-4">
                      ...
                      <motion.button
                        ...
                        className={`text-left py-2 text-gray-700 hover:text-gray-900 ${
                          currentPage === 'employee-applications' ? 'text-blue-600' : ''
                        }`}
                      >
                        申請一覧
                      </motion.button>
                      <motion.button
                        ...
                        className={`text-left py-2 text-gray-700 hover:text-gray-900 ${
                          currentPage === 'employee-my-applications' ? 'text-blue-600' : ''
                        }`}
                      >
                        マイ申請
                      </motion.button>
                  ...
                  {role === 'admin' && (
                    <nav className="flex flex-col gap-4">
                      ...
                      <motion.button
                        ...
                        className={`text-left py-2 text-gray-700 hover:text-gray-900 ${
                          currentPage === 'admin-users' || currentPage === 'admin-user-chat' ? 'text-blue-600' : ''
                        }`}
                      >
                        メッセージ
                      </motion.button>
